...
namespace WinFormsApp1
{
    public partial class EditUser : Form
    {
        ...
        {
            updatePersonWithoutPwd(textBox1.Text, textBox2.Text, textBox3.Text, textBox4.Text, textBox5.Text,
                dt.Rows[ind]["pdID"].ToString(),
                dt.Rows[ind]["id"].ToString(), database);
            updateTable();
        }

        private  void updatePersonWithoutPwd(string s1, string s2, string s3, string s4, string s5, string s7, string s8, DataBase database)
        {
            SqlDataAdapter adapter = new SqlDataAdapter();
            DataTable table = new DataTable();
            string sqlExpression = "updatePersonWithoutPass";
        ...
        private void updatePerson(string s1, string s2, string s3, string s4, string s5, string s6, string s7, string s8, DataBase database)
        {
            SqlDataAdapter adapter = new SqlDataAdapter();
            DataTable table = new DataTable();
